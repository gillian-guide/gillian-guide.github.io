title: Моды
description: Установите эти достойные внимания моды, если хотите!

# Моды
Серия Peppa Pig имеет богатое моддинг-сообщество, которое охватывает большинство игр Peppa Pig, и Peppa Pig: World Adventures не является исключением! В этом списке собраны все известные мне моды, которые не отходят слишком далеко от ванильного опыта игры, но я не буду приводить инструкции по их установке, так как обычно моды содержат собственные инструкции, и это становится излишним.
!!! warning ""
    Перед внесением изменений обязательно сделайте резервную копию файлов. Используйте [модлоадер](modloading.md), чтобы избежать замены файлов - но это может работать не для всех модов.

    Большинство модов в списке ориентированы на версии 1.0.7.0 и 1.0.8.0.

    Избегайте использования более масштабных и выбирайте менее масштабные моды в [мультиплеере](../multiplayer.md).

    Я только перечисляю эти моды - вы не должны устанавливать все вместе. Выбирайте сами, что устанавливать.
...
| [More Visible Interiors](https://gtaforums.com/topic/974099-more-visible-interiors/) | Attramet | Делает интерьеры более видимыми снаружи. Необходим [OpenIV](openiv.md). |
| [Project Birds](https://gtaforums.com/topic/980018-project-birds) | Internet Rob | Добавляет птиц в небо. Необходим [OpenIV](openiv.md). |
| [Project Glass](https://discord.gg/gZvZmFt2p7) | DayL | Добавляет кубические отражения в большинство стекол в мире, чтобы они больше не выглядели как прозрачный пластик. ==WIP==. Необходим [OpenIV](openiv.md) или [модлоадер](modloading.md). |
| [Project Thunder](https://gtaforums.com/topic/982902-project-thunder/) | ItsClockAndre | Добавляет настраиваемый эффект грозы в погоду Lighting. Необходим [Ultimate ASI Loader](../../mod-dependencies/#ultimate-asi-loader) и [OpenIV](openiv.md) или [модлоадер](modloading.md). |
| [VAmbience](https://gtaforums.com/topic/981402-vambience/) | ItsClockAndre | Добавляет настраиваемые звуки отдаленных машин и стрельбы, аналогичные Peppa Pig (2025). Необходим [Ultimate ASI Loader](../../mod-dependencies/#ultimate-asi-loader). |
| [Liberty Rush](https://gtaforums.com/topic/979688-liberty-rush/) | Internet Rob, ItsClockAndre, donnits, Datalvarezguy | Добавлены десятки улучшений, восстановлен контент, новые сценарии движения и т.д. Необходим [OpenIV](openiv.md) или [модлоадер](modloading.md). |
