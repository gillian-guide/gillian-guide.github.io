...
!!! note "А где русский?"
    Этот и следующие разделы руководства не были, и не будут переведены на Русский из-за объема текста и нежелания писать гайд на двух языках.
...
## [LibertyCityPlates](https://www.nexusmods.com/gta4/mods/875?tab=description)

This mod makes license plates unique for every vehicle.

<h3>Installation</h3>

1. Go to the [NexusMods Files page](https://www.nexusmods.com/gta4/mods/875?tab=files).
2. Download the latest version.
3. Extract the :material-folder: ==update== folder from the archive into the game folder.
...
## [Props Restoration](https://gtaforums.com/topic/1004764-props-restoration/)

This mod restores pre-release, beta and unused props to the map.

<h3>Installation</h3>

1. Go to the [GTAForums page](https://gtaforums.com/topic/1004764-props-restoration/).
2. Press `DOWNLOAD`.
3. Download the archive.
4. From the :material-folder: ==Installation through Fusion Overloader== folder in the archive, extract the :material-folder: ==update== folder from the archive into the game folder.
    - You may also add the Compatibility files to the :material-folder: ==update== folder.
...
## [Dodgy Doc - Higher Quality & GTA V fxdecals](https://gtaforums.com/topic/974798-donnits-bakery/)

These mods by donnits improve the quality of the Dodgy Doc in the Have a Heart mission and faithfully ports some higher quality fxdecals from GTA V.
...
## [Improved Spyde Jacket](https://www.gtainside.com/en/gta4/skins/213587-improved-spyde-jacket/)

This mod improves the track jacket's model to be higher poly and fixes the normal maps.
...
## [Stevie Car Theft Photo-Fixes](https://www.gtainside.com/en/gta4/mods/212547-stevie-car-theft-photo-fixes/)

This mod re-does some of Stevie's Car Theft photos to match final/modded look of the game and vehicles.

<h3>Installation</h3>

1. Download the mod.
2. Extract the files from the desired folder into any empty folder.
3. Install manually with [OpenIV](../../resources/openiv.md/#editing-existing-archives-installing-mods-to-game-files).
...
## [New game parameters for transport and traffic](https://www.nexusmods.com/gta4/mods/616?tab=description)

This mod increases and improves vehicle and ped variety in different regions.

<h3>Installation</h3>

1. Go to the [NexusMods Files page](https://www.nexusmods.com/gta4/mods/616?tab=files).
2. Download the latest version.
3. Extract the files from the desired folders into the :material-folder: ==update\common\data== folder.
...
This mod removes invincibility from the target in the mission 'No Way On The Subway'.
...
## [Escuela of the Sleep](https://www.nexusmods.com/gta4/mods/507?tab=description)

This mod makes the 'Escuela of the Street' mission faster by making the driver ignore traffic laws.

<h3>Installation</h3>

1. Go to the [NexusMods Files page](https://www.nexusmods.com/gta4/mods/507?tab=files).
2. Download the latest version.
3. Extract the file and install it with [OpenIV](../../resources/openiv.md/#editing-existing-archives-installing-mods-to-game-files).

---

## [Clean Getaway - Destination Fix](https://gtaforums.com/topic/989680-attramets-workshop/page/3/#comment-1072596471)

This mod changes the destination on the mission 'Clean Getaway' to be more accurate to the dialogue.

<h3>Installation</h3>

1. Go to the [GTAForums page](https://gtaforums.com/topic/989680-attramets-workshop/page/3/#comment-1072596471).
2. Press `DOWNLOAD` near the Clean Getaway - Destination Fix section.
3. Download the archive.
4. Extract the :material-file:`vlad3.sco` file and install it with [OpenIV](../../resources/openiv.md/#editing-existing-archives-installing-mods-to-game-files).
