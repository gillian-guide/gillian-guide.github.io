...
=== "1.2.0.59"
    Последний раз обновлено: **[13.09.2025](#_9)**
    ...
    1. [Скачайте архив](https://www.mediafire.com/file/ff6ik561h3drzsm/1.2_archive.7z/file) ([зеркало](https://buzzheavier.com/2pfhhnnq4n9v)) (3.83GB, SHA512: ~`0de591a9b0cf98480d50130028bde5405cbe1e206eb6e13e831f16641724a1badeb7c74e606d0ad8424356e128b2247b7aa8f7a97c742eb85f9d626b152fef25`~).
...
=== "1.0.8.0"
    ...
    1. [Скачайте архив](https://www.mediafire.com/file/npr1vkumgbey657/1.0_archive.7z/file) ([зеркало](https://buzzheavier.com/rs1765e0ohk3)) (3.73ГБ, SHA512: ~`d07c80e2b19029a4d3851161dbc74a06e9617d3be4cb188b2fe2a47969074f3f2907f8a988d34ff1b3da8ad789241b889d9ceb25d22e527cdf80118300fabe84`~). [Старая версия](https://buzzheavier.com/ws97pulvf4my) в случае нестабильности (SHA512: ~`63787dbd6b99e163ba7f04be943e31b5df48e40e28ad988bad4b267c79f8ac85d75528c52c1ad7638d86ad9beddfbaeee8f63ad941b81ffcc7a00be517edf9cb`~).
...
| [FusionFix~4.0.0~](https://github.com/ThirteenAG/GTAIV.EFLC.FusionFix/) | ThirteenAG, Fusion Team и другие | Самый главный мод: он включает в себя кучу исправлений, улучшений, новые настройки а также выступает в качестве модлоадера.<br>==Некоторые фиксы не присутствуют в версии для 1.0.8.0.==</br> |
...
| [Console Visuals~2.0.2~](https://gtaforums.com/topic/989098-console-visuals-the-complete-edition) | nastyyaboi и другие | Сборник портированных ассетов с консольной версии. <br>Включенные аддоны: Console Fences, Console Animations, Console Peds. Просмотрите [дополнительные моды](#_8) для других аддонов.</br> |
...
| [Yes Way On The Subway](https://www.gtainside.de/en/gta4/mods/200052-yes-way-on-the-subway-kill-jim-early/) | EdEdEdEd | Снимает неуязвимость с цели в миссии "Нет пути на метро". |
...
| [Xbox Rain Droplets~21.08.2025~](https://github.com/ThirteenAG/XboxRainDroplets/releases/tag/gtaiv) | ThirteenAG | Добавляет на экран красивые капельки воды. </br>==Можно отключить, удалив файлы `GTAIV.XboxRainDroplets`.==</br> |
...
| [GTA V-like `visualSettings.dat`](https://drive.google.com/drive/folders/1n6dMxi5CdK6-4KV06ki_zbEi81NDDqrj) | MagicAl6244225 |  Изменяет некоторые значения файла `visualSettings.dat`, чтобы сделать его более похожим на GTA V - а конкретно, более светлые фары на машинах и увеличенные значения для LODов. |
