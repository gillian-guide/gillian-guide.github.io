...
=== "1.2.0.59"
    Последний раз обновлено: **[13.01.2026 (последнее крупное обновление)](#_9)**
    ...
    1. [Скачайте архив](https://www.mediafire.com/file/9w2oo21ahcjj5vl/1.2_archive.7z/file) ([зеркало](https://buzzheavier.com/5njpjfmr8esq)) (4.10GB, SHA512: ~`bbf9e5ce8d5c05b6cf88ae49e3203f5cf39d06795a78da764c4d375afe639822486023a7201cf6d41c5b259d406bb37ac492150550d46c6c27388dbe7992b083`~).
...
=== "1.0.8.0"
    ...
    1. [Скачайте архив](https://www.mediafire.com/file/d52khdd0bpkxhf9/1.0_archive.7z/file) ([зеркало](https://buzzheavier.com/5acmemd6wubj)) (4.14ГБ, SHA512: ~`c5d5f2351bd37a3840986f2eba7aad67a1f4a34b5a27ad0334d6b90b8ac95f7ebc7d7ff9ebbff0c17b688998502724cfc53ae2174adbba63576ae19ffc14bf18`~).
...
| [FusionFix~4.0.5~](https://github.com/ThirteenAG/GTAIV.EFLC.FusionFix/) | ThirteenAG, Fusion Team и другие | Самый главный мод: он включает в себя кучу исправлений, улучшений, новые настройки а также выступает в качестве модлоадера. |
...
| [Restored Trees Position~16.10.2025~](https://gtaforums.com/topic/984591-restored-trees-position/) | Attramet | Восстанавливает деревья, которые присутствовали в бета-версиях, но были вырезаны в финальном релизе - либо случайно, либо из-за проблем с производительностью. |
| [More Visible Interiors~1.7.1~](https://gtaforums.com/topic/974099-more-visible-interiors/) | Attramet | Делает интерьер более заметными снаружи, хотя имеет недостаток в виде появления интерьеров на глазах. |
...
| [LibertyCityPlates~1.2.6.1~](https://www.nexusmods.com/gta4/mods/875?tab=description) | Ash_735 | Делает номерной знак уникальным для каждой машины. |
...
| [New game parameters for transport and traffic~1.6.5~](https://www.nexusmods.com/gta4/mods/616?tab=description) | Ushan27 | Увеличивает и улучшает разнообразие транспорта и педов в разных регионах. |
...
| [Xbox Rain Droplets~08.01.2026~](https://github.com/ThirteenAG/XboxRainDroplets/releases/tag/gtaiv) | ThirteenAG | Добавляет на экран красивые капельки воды. </br>==Можно отключить, удалив файлы `GTAIV.XboxRainDroplets`.==</br> |
| [Props Restoration](https://gtaforums.com/topic/1004764-props-restoration/) | Attramet | Ввостанавливает пре-релизные, бета и неиспользованые пропы на карту. |
