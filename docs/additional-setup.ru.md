...
| Motion Blur | По педпочтению | Вкл | Эта настройка управляет эффектом размытия в движении. <br>==Доступно только в меню `Настройки` - `Экран` при использовании [FusionFix](essential-modding/fusionfix.md).==</br> |
