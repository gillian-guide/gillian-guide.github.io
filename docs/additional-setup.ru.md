...
| FXAA | Вкл | Вкл | Эта настройка управляет FXAA (простой метод сглаживания) - используйте [FusionFix](essential-modding/fusionfix.md) для её появления, или [Shader Fixes](essential-modding/shader-fixes.md) чтобы всегда иметь FXAA. |
