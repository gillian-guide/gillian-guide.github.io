...
=== "1.0.8.0"
	...
	| [Fix Collection от iiCriminnaaL, nkjellman и меня](https://cdn.discordapp.com/attachments/1129814754593091594/1132775010780577893/FixCollection.7z) | Несколько исправлений из Responsivle Plus и Graphics Fix, а именно - `stipple.wtd`, `coronas.wtd`, `carcols.dat` и `cargrp.dat` и файлы, связанные с эффектами брызг дождя. Моя работа здесь заключается только в том, что я их собрал отдельно. |
