...
| TreeFX | Off | On | This settings makes vegetation look more console-like - it'll appear litten up. I don't like this effect personally. <br>==Only available when using [FusionFix](essential-modding/fusionfix.md).==</br> |
