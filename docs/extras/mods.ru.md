...
# Моды
Серия Grand Theft Auto имеет богатое моддинг-сообщество, которое охватывает большинство игр GTA, и GTA IV не является исключением! В этом списке собраны все известные мне моды, которые не отходят слишком далеко от ванильного опыта игры, но я не буду приводить инструкции по их установке, так как обычно моды содержат собственные инструкции, и это становится излишним.
!!! warning ""
...
| :-: | :------: | :------: |
| [Console Visuals](https://gtaforums.com/topic/989098-console-visuals-the-complete-edition) | nastyyaboi, Tomasak, Ash_735, Parallellines, Vaani, AssaultKifle47, RaphaelK12 | Этот проект портирует ассеты из консольной версии. Необходим [OpenIV](openiv.md) или [модлоадер](modloading.md). |
...
| [VAmbience](https://gtaforums.com/topic/981402-vambience/) | ItsClockAndre | Добавляет настраиваемые звуки отдаленных машин и стрельбы, аналогичные GTA V. Необходим [Ultimate ASI Loader](../../mod-dependencies/#ultimate-asi-loader). |
