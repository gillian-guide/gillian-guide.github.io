...
| [Project Birds](https://gtaforums.com/topic/980018-project-birds) | Internet Rob | Добавляет птиц в небо. Необходим [OpenIV](openiv.md) или [модлоадер](modloading.md). |
...
| [Player Outfit Texture Fixes](https://gtaforums.com/topic/925011-player-outfit-texture-fixes) | B Dawg | Исправлены зеленоватые текстур одежды. Необходим [OpenIV](openiv.md) или [модлоадер](modloading.md). |
...
| [Fixed LCPD Buffalo](https://www.gtainside.com/en/gta4/cars/181342-fixed-lcpd-buffalo/) | Ooboy | Исправлены ошибки в модели и текстуре полицейского буйвола. Необходим [OpenIV](openiv.md) или [модлоадер](modloading.md). |
...
| [Cutscene Collisions](https://zolika1351.pages.dev/mods/ivcutscenecols) | Zolika1351 | Добавляет коллизии в интерьеры из катсцен. Необходим [OpenIV](openiv.md) или [модлоадер](modloading.md). |
| [Fixed Cutscene Characters](https://zolika1351.pages.dev/mods/ivcutscenepeds) | Zolika1351 | Исправлены сломанных педов из катсцен (при ручном спавне). Необходим [OpenIV](openiv.md) или [модлоадер](modloading.md). |
