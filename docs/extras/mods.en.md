...
| [Cutscene Collisions](https://zolika1351.pages.dev/mods/ivcutscenecols) | Zolika1351 | Adds collisions to cutscene interiors. Requires [OpenIV](openiv.md) or a [modloader](modloading.md). |
| [Fixed Cutscene Characters](https://zolika1351.pages.dev/mods/ivcutscenepeds) | Zolika1351 | Fixes broken cutscene peds (if you manually spawn them in). Requires [OpenIV](openiv.md) or a [modloader](modloading.md). |
