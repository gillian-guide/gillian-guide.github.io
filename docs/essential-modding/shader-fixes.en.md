...
=== "Standalone"
    * Go to the [Releases](https://github.com/Parallellines0451/GTAIV.ShaderFixesCollection/releases) page.
    * Download the latest version.
    * Extract the files from the :material-folder:==1. Main== and :material-folder:==2. ASI for 1.0.7.0 and 1.0.8.0== into the game folder, replacing all files when prompted.
