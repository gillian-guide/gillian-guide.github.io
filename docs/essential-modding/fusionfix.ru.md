...
!!! warning "Совместимость" 
    Этот мод официально поддерживает только Complete Edition, но благодаря коммьюнити вы можете использовать его и с патчами 1.0.8.0 и 1.0.7.0.
...
=== "1.0.8.0"
    * Перейдите на страницу [релиза 1.10](https://zolika1351.pages.dev/mods/ivpatch/downgrading). Не переживайте - там обновленная версия.
    * Скачайте эту версию.
